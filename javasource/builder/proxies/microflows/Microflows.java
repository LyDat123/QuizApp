...
public final class Microflows
{
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder sUB_ConnectedSelectorBuilder(
		builder.proxies.Test _test
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Builder.SUB_ConnectedSelector");
		builder = builder.withParam("Test", _test);
		return builder;
	}

	public static builder.proxies.ConnectedSelector sUB_ConnectedSelector(
		IContext context,
		builder.proxies.Test _test
	)
	{
		Object result = sUB_ConnectedSelectorBuilder(
				_test
			)
			.execute(context);
		return result == null ? null : builder.proxies.ConnectedSelector.initialize(context, (IMendixObject) result);
